...
public class BasicStreamingJob {
    ...
    private static DataStream<String> createSourceFromStaticConfig(StreamExecutionEnvironment env) {
        ...
        //inputProperties.put(ConsumerConfigConstants.AWS_ACCESS_KEY_ID, "AKIAX7PDWOE4M7HHXLVD");
        //inputProperties.put(ConsumerConfigConstants.AWS_SECRET_ACCESS_KEY, "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");
    ...
    private static FlinkKinesisProducer<String> createSinkFromStaticConfig() {
        ...
        //outputProperties.put(ConsumerConfigConstants.AWS_ACCESS_KEY_ID, "AKIAX7PDWOE4M7HHXLVD");
        //outputProperties.put(ConsumerConfigConstants.AWS_SECRET_ACCESS_KEY, "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");
